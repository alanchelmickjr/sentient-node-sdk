...
export declare abstract class LLM {
     ...
     */
    abstract generate(prompt: string, maxTokens?: number, temperature?: number, ...kwargs: any[]): Promise<string>;
    /**
     ...
     */
    abstract streamGenerate(prompt: string, maxTokens?: number, temperature?: number, ...kwargs: any[]): AsyncIterable<string>;
    /**
